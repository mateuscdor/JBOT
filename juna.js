...
for (let m of asmaul) {
		   ...
		   case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'tupai':
            ...
            let stik = await fetchJson(`https://api.dapuhy.xyz/api/search/searchsticker?query=${q}&apikey=DappaAnjing`)
            ...
            db.data.users[m.sender].limit -= 1 
            if (!q) throw `Example : ${prefix + command} Shiba Inu`
            juna.sendImage(m.chat, `https://api.dapuhy.xyz/api/search/yandeximage?query=${q}&apikey=DappaAnjing`, `• ••º•» 𝗬𝗔𝗡𝗗𝗘𝗫 𝗜𝗠𝗔𝗚𝗘 «•º•• •\n\n࿈ *Query :* ${q}`, m, { mentions: [m.sender] })
            }
            break
            case 'asupan62': {
            if (db.data.chats[m.chat].antiporn) throw 'Antiporn sedang diaktifkan digroup ini, silahkan izin ke admin untuk bisa menggunakan fitur ini di group!'
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            juna.sendMessage(m.chat, { caption: 'Jan Ngaceng Ya Anjc', video: { url: 'https://api.dapuhy.xyz/api/asupan/asupan?apikey=DappaAnjing' }, footer: wm, buttons: [{buttonId: `${prefix}asupan62`, buttonText: {displayText: '𝗡𝗘𝗫𝗧'}, type: 1}] }, {quoted: m})
            }
            break
            case 'asupansantuy': {
            if (db.data.chats[m.chat].antiporn) throw 'Antiporn sedang diaktifkan digroup ini, silahkan izin ke admin untuk bisa menggunakan fitur ini di group!'
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            juna.sendMessage(m.chat, { caption: 'Jan Ngaceng Ya Anjc', video: { url: 'https://api.dapuhy.xyz/api/asupan/asupansantuy?apikey=DappaAnjing' }, footer: wm, buttons: [{buttonId: `${prefix}asupansantuy`, buttonText: {displayText: '𝗡𝗘𝗫𝗧'}, type: 1}] }, {quoted: m})
            }
            break
            case 'asupanbocil': {
            if (db.data.chats[m.chat].antiporn) throw 'Antiporn sedang diaktifkan digroup ini, silahkan izin ke admin untuk bisa menggunakan fitur ini di group!'
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            juna.sendMessage(m.chat, { caption: 'Jan Ngaceng Ya Anjc', video: { url: 'https://api.dapuhy.xyz/api/asupan/asupanbocil?apikey=DappaAnjing' }, footer: wm, buttons: [{buttonId: `${prefix}asupanbocil`, buttonText: {displayText: '𝗡𝗘𝗫𝗧'}, type: 1}] }, {quoted: m})
            }
            break
            case 'asupanukhty': {
            if (db.data.chats[m.chat].antiporn) throw 'Antiporn sedang diaktifkan digroup ini, silahkan izin ke admin untuk bisa menggunakan fitur ini di group!'
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            juna.sendMessage(m.chat, { caption: 'Jan Ngaceng Ya Anjc', video: { url: 'https://api.dapuhy.xyz/api/asupan/asupanukhty?apikey=DappaAnjing' }, footer: wm, buttons: [{buttonId: `${prefix}asupanukhty`, buttonText: {displayText: '𝗡𝗘𝗫𝗧'}, type: 1}] }, {quoted: m})
            }
            break
            ...
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            juna.sendMessage(m.chat, { caption: 'Jan Ngaceng Ya Anjc', video: { url: 'https://api.dapuhy.xyz/api/asupan/asupanrikagusriani?apikey=DappaAnjing' }, footer: wm, buttons: [{buttonId: `${prefix}asupanrikagusriani`, buttonText: {displayText: '𝗡𝗘𝗫𝗧'}, type: 1}] }, {quoted: m})
            }
            break
            case 'asupanghea': {
            if (db.data.chats[m.chat].antiporn) throw 'Antiporn sedang diaktifkan digroup ini, silahkan izin ke admin untuk bisa menggunakan fitur ini di group!'
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            juna.sendMessage(m.chat, { caption: 'Jan Ngaceng Ya Anjc', video: { url: 'https://api.dapuhy.xyz/api/asupan/asupanghea?apikey=DappaAnjing' }, footer: wm, buttons: [{buttonId: `${prefix}asupanghea`, buttonText: {displayText: '𝗡𝗘𝗫𝗧'}, type: 1}] }, {quoted: m})
            }
            break
            ...
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
                ...
                let buing = await fetchJson(`https://api.dapuhy.xyz/api/search/bingsearch?query=${text}&page=2&apikey=DappaAnjing`)
