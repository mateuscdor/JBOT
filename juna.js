...
࿈ ${prefix}sticksearch [query]
࿈ ${prefix}xcaristick [query]
࿈ ${prefix}herolist
...
juna.sendMessage(m.chat, { caption: hasil, location: { jpegThumbnail: ings }, footer: wm, buttons: [{buttonId: `${prefix}ceritahoror`, buttonText: {displayText: '𝗡𝗘𝗫𝗧'}, type: 1}], headerType: 'LOCATION', mentions: [m.sender] }, {quoted: m})
break
case 'filebokep':
if (db.data.chats[m.chat].antiporn) throw 'Antiporn sedang diaktifkan digroup ini, silahkan izin ke admin untuk bisa menggunakan fitur ini di group!'
if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
...
for (let m of asmaul) {
		   ...
		   case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'tupai':
            ...
            break
            case 'stickersearch': case 'sticksearch': case 'caristicker': case 'caristick': {
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            if (!q) throw `Example : ${prefix + command} Shiba Inu`
            let stik = await fetchJson(`https://api.dapuhy.xyz/api/search/searchsticker?query=${q}&apikey=DapApi`)
            stiknha = await pickRandom(stik.sticker)
            juna.sendImageAsSticker(m.chat, stiknha, m, { packname: global.packname, author: global.author })
            }
            break
            case 'yimage': case 'yandeximage': {
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            if (!q) throw `Example : ${prefix + command} Shiba Inu`
            juna.sendImage(m.chat, `https://api.dapuhy.xyz/api/search/yandeximage?query=${q}&apikey=DapApi`, `• ••º•» 𝗬𝗔𝗡𝗗𝗘𝗫 𝗜𝗠𝗔𝗚𝗘 «•º•• •\n\n࿈ *Query :* ${q}`, m, { mentions: [m.sender] })
            }
            break
            case 'asupan62': {
            if (db.data.chats[m.chat].antiporn) throw 'Antiporn sedang diaktifkan digroup ini, silahkan izin ke admin untuk bisa menggunakan fitur ini di group!'
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            juna.sendMessage(m.chat, { caption: 'Jan Ngaceng Ya Anjc', video: { url: 'https://api.dapuhy.xyz/api/asupan/asupan?apikey=DapApi' }, footer: wm, buttons: [{buttonId: `${prefix}asupan62`, buttonText: {displayText: '𝗡𝗘𝗫𝗧'}, type: 1}] }, {quoted: m})
            }
            break
            case 'asupansantuy': {
            if (db.data.chats[m.chat].antiporn) throw 'Antiporn sedang diaktifkan digroup ini, silahkan izin ke admin untuk bisa menggunakan fitur ini di group!'
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            juna.sendMessage(m.chat, { caption: 'Jan Ngaceng Ya Anjc', video: { url: 'https://api.dapuhy.xyz/api/asupan/asupansantuy?apikey=JunApi2' }, footer: wm, buttons: [{buttonId: `${prefix}asupansantuy`, buttonText: {displayText: '𝗡𝗘𝗫𝗧'}, type: 1}] }, {quoted: m})
            }
            break
            case 'asupanbocil': {
            if (db.data.chats[m.chat].antiporn) throw 'Antiporn sedang diaktifkan digroup ini, silahkan izin ke admin untuk bisa menggunakan fitur ini di group!'
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            juna.sendMessage(m.chat, { caption: 'Jan Ngaceng Ya Anjc', video: { url: 'https://api.dapuhy.xyz/api/asupan/asupanbocil?apikey=JunApi2' }, footer: wm, buttons: [{buttonId: `${prefix}asupanbocil`, buttonText: {displayText: '𝗡𝗘𝗫𝗧'}, type: 1}] }, {quoted: m})
            }
            break
            case 'asupanukhty': {
            if (db.data.chats[m.chat].antiporn) throw 'Antiporn sedang diaktifkan digroup ini, silahkan izin ke admin untuk bisa menggunakan fitur ini di group!'
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            juna.sendMessage(m.chat, { caption: 'Jan Ngaceng Ya Anjc', video: { url: 'https://api.dapuhy.xyz/api/asupan/asupanukhty?apikey=JunApi2' }, footer: wm, buttons: [{buttonId: `${prefix}asupanukhty`, buttonText: {displayText: '𝗡𝗘𝗫𝗧'}, type: 1}] }, {quoted: m})
            }
            break
            ...
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            juna.sendMessage(m.chat, { caption: 'Jan Ngaceng Ya Anjc', video: { url: 'https://api.dapuhy.xyz/api/asupan/asupanrikagusriani?apikey=JunApi2' }, footer: wm, buttons: [{buttonId: `${prefix}asupanrikagusriani`, buttonText: {displayText: '𝗡𝗘𝗫𝗧'}, type: 1}] }, {quoted: m})
            }
            break
            case 'asupanghea': {
            if (db.data.chats[m.chat].antiporn) throw 'Antiporn sedang diaktifkan digroup ini, silahkan izin ke admin untuk bisa menggunakan fitur ini di group!'
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            juna.sendMessage(m.chat, { caption: 'Jan Ngaceng Ya Anjc', video: { url: 'https://api.dapuhy.xyz/api/asupan/asupanghea?apikey=JunApi2' }, footer: wm, buttons: [{buttonId: `${prefix}asupanghea`, buttonText: {displayText: '𝗡𝗘𝗫𝗧'}, type: 1}] }, {quoted: m})
            }
            break
            case 'bing': case 'bingsearch': {
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
                db.data.users[m.sender].limit -= 1 
                if (!text) throw `Example : ${prefix + command} Scarlett Johansson`
                let buing = await fetchJson(`https://api.dapuhy.xyz/api/search/bingsearch?query=${text}&page=2&apikey=DapApi`)
                let teks = `• ••º•» 𝗕𝗜𝗡𝗚 𝗦𝗘𝗔𝗥𝗖𝗛 «•º•• •\n\n*Result From :* ${text}\n`
                for (let g of buing.result) {
                teks += `\n࿈ *Title* : ${g.title}\n`
	    ...
	    if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
             ...
             urlButton: {
               ...
               url: `${search.all[0].url}`
                ...
                bgs = await getBuffer(search.all[0].thumbnail)
        ...
        if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
             ...
             urlButton: {
               ...
               url: `${bkp.result[0].link}`
                ...
                let bkp = await fetchJson(`https://api.dapuhy.xyz/api/search/javhdporn?query=${q}&apikey=DapApi`)
...
࿈ Url : ${anu.url}`,
            ...
            break
            case 'liriklagu': case 'lirik': {
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            if (!text) return reply('Nyari Film Apa?')
            reply(mess.wait)
            zyapi.lirik(text).then(async result => {
            let teks = `• ••º•» 𝗟𝗜𝗥𝗜𝗞 𝗟𝗔𝗚𝗨 «•º•• •\n\n*Result From :* ${text}\n࿈ *Lirik :*\n${result.lirik}`
            let bntex = [{
             urlButton: {
               displayText: '𝗢𝗪𝗡𝗘𝗥',
               url: 'https://wa.me/message/DPO22JW4FXHHN1'
           ...
           bgs = await getBuffer(result.thumb)
           juna.send5Loc(m.chat, teks, wm, bgs, bntex)
            })
            .catch((err) => {
            console.log(err)
            ...
            break
            case 'xcaristicker': case 'xcaristick': case 'xsearchsticker': case 'xsearchstick': {
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
            db.data.users[m.sender].limit -= 1 
            if (!q) return reply('Nyari sticker apa?')
            reply(mess.wait)
        ...
        db.data.users[m.sender].limit -= 1 
             ...
             urlButton: {
               ...
               url: 'https://wa.me/message/DPO22JW4FXHHN1'
                ...
                bgs = await getBuffer(thumbnail)
                juna.send5Loc(m.chat, `࿈ Title : ${title}\n࿈ File Size : ${media[0].formattedSize}\n࿈ Url : ${url}\n࿈ Ext : MP3\n࿈ Resolusi : ${args[1] || '128kbps'}`, wm, bgs, bntex)
            ...
            if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit)
             ...
             urlButton: {
               ...
               url: 'https://wa.me/message/DPO22JW4FXHHN1'
                ...
                bgs = await getBuffer(media.thumb)
                juna.send5Loc(m.chat, `࿈ Title : ${media.title}\n࿈ File Size : ${media.filesizeF}\n࿈ Url : ${isUrl(text)}\n࿈ Ext : MP3\n࿈ Resolusi : ${args[1] || '128kbps'}`, wm, bgs, bntex)
